...
== USECASE4: Given ingredient X, find cocoingredients which have mutual coingredients with X.

RECIPE DISCOVERER
So, from the results below, I should clearly try to come up with a recipe that has tomatoes, zucchini, soy sauce, and garlic for example. Which actually doesn't sound too bad!
