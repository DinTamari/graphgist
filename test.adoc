...
image::http://postimg.org/image/aykhvhpvl/[width=800]
...
[source,cypher]
----
MATCH (f:Food)-[relationship]-(:Recipe {name: "Guacamole"}) 
RETURN f.name, relationship.quantity AS quantity, relationship.prepare AS prep
----
//table
